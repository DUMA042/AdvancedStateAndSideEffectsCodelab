...
import androidx.compose.samples.crane.data.ASPEN
...
@Composable
fun checkscaffold(){
    val Des=DestinationsLocalDataSource()
    val Des_d:DestinationsRepository= DestinationsRepository(Des)
    CraneTheme {
     CraneHomeContent(
         { ExploreModel(
             city = ASPEN,
             description = "2241 Restaurants",
             imageUrl = "https://images.unsplash.com/photo-1542384557-0824d90731ee?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=${250}"
         )},
         {},
         modifier = Modifier,
         MainViewModel(Des_d,Dispatchers.IO)
    )
}
}
